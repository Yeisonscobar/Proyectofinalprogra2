...
public class DialogPais extends javax.swing.JDialog {
    ...
    private void btnGuardareActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardareActionPerformed
        try{
            ...
            if(nombre.equals("")) msj+="Falta agregar nombre de país\n";
            if(msj.equals("")){
                ...
                if(pais==null){//agregar
                    if(daoPais.registrar(new Pais(nombre,abreviaturaPais,cod,nuevaRuta,album.getIdAlbum()))){
                        JOptionPane.showMessageDialog(null, "País registrado","Registrar País",JOptionPane.INFORMATION_MESSAGE);
                        dispose();
                    }else{
                        JOptionPane.showMessageDialog(null, "Error al registrar pais","Registrar País",JOptionPane.WARNING_MESSAGE);
                    }
                }else{//actualizar
                    if(daoPais.modificar(new Pais(pais.getIdPais(),nombre,abreviaturaPais,cod,nuevaRuta,album.getIdAlbum()))){
                        JOptionPane.showMessageDialog(null, "País actualizado","Modificar País",JOptionPane.INFORMATION_MESSAGE);
                         dispose();
                    }else{
                        JOptionPane.showMessageDialog(null, "Error al actualizar pais","Modificar País",JOptionPane.WARNING_MESSAGE);
                    }
                }
            }else{
                JOptionPane.showMessageDialog(null, msj,"País",JOptionPane.WARNING_MESSAGE);
            }
        }catch(Exception ex){
